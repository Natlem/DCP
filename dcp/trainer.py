...
class Trainer(object):
    ...
    def __init__(self, model, train_loader, val_loader, settings, logger,
                 v_logger, optimizer_state=None, run_count=0):
    ...
    def train(self, epoch):
        ...
        if self.v_logger is not None:
            self.v_logger.log_scalar('train_top1_error', top1_error.avg, self.run_count)
            self.v_logger.log_scalar('train_top5_error', top5_error.avg, self.run_count)
            self.v_logger.log_scalar('train_loss', top1_loss.avg, self.run_count)
            self.v_logger.log_scalar("lr", self.lr, self.run_count)
    ...
    def val(self, epoch):
        ...
        if self.v_logger is not None:
            self.v_logger.log_scalar("val_top1_error", top1_error.avg, self.run_count)
            self.v_logger.log_scalar("val_top5_error", top5_error.avg, self.run_count)
            self.v_logger.log_scalar("val_loss", top1_loss.avg, self.run_count)
